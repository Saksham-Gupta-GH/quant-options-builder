...
export default function Home() {
  return (
    <div className="space-y-12">
      <section>
        <div className="mb-6">
          <h1 className="text-3xl font-normal text-[#202124] tracking-tight mb-2 flex items-center">
            Options Strategy Builder
          </h1>
          <p className="text-[#5F6368] max-w-3xl text-base leading-relaxed">
      ...
      <section>
        <div className="mb-6">
          <h2 className="text-2xl font-normal text-[#202124] tracking-tight mb-2">
            Volatility Surface
          </h2>
          <p className="text-[#5F6368] max-w-3xl text-base leading-relaxed">
